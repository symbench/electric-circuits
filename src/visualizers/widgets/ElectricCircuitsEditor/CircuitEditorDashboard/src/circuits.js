const defineElectricCircuitsDomain = function (joint) {
    ...
    const SinglePinComponent = Component.define('circuit.SinglePinComponent', {
        attrs: {
            '.pin': {ref: '.body', 'ref-x': 0.5, 'ref-y': 0.2, magnet: true, port: 'p', portid: 'p', spiceIdx: 0}
        }
    }, {
    ...
    const Transistor = ThreePinComponent.define('circuit.Transistor', {
        attrs: {
            '.pin1': {ref: '.body', 'ref-x': 0.625, 'ref-y': 0.125, magnet: true, port: 'C', portid: 'C', spiceIdx: 0},
            '.pin2': {ref: '.body', 'ref-x': 0.0625, 'ref-y': 0.5, magnet: true, port: 'B', portid: 'B', spiceIdx: 1},
            '.pin3': {ref: '.body', 'ref-x': 0.625, 'ref-y': 0.875, magnet: true, port: 'E', portid: 'E', spiceIdx: 2}
        }
    });
    ...
    const MOSFET = FourTerminalComponent.define('circuit.MOSFET', {
        attrs: {
            '.pin1': {ref: '.body', 'ref-x': 0.625, 'ref-y': 0.0625, magnet: true, port: 'D', portid: 'D', spiceIdx: 0},
            '.pin2': {ref: '.body', 'ref-x': 0.0625, 'ref-y': 0.5, magnet: true, port: 'G', portid: 'G', spiceIdx: 1},
            '.pin3': {ref: '.body', 'ref-x': 0.9375, 'ref-y': 0.5, magnet: true, port: 'B', portid: 'B', spiceIdx: 2},
            '.pin4': {ref: '.body', 'ref-x': 0.625, 'ref-y': 0.9375, magnet: true, port: 'S', portid: 'S', spiceIdx: 3}
        }
    }, {}, {
        toELKJSON: mos => {
    ...
    const CCC = Source.define('circuit.CCC', {
        attrs: {
            ...
            '.pin1': {spiceIdx: undefined},
            '.pin2': {spiceIdx: undefined},
            '.pin3': {spiceIdx: 0},
            '.pin4': {spiceIdx: 1}
        }
    });
