"""
This script is called by the plugin-wrapper, RecommendNextComponentsMock.js, which passes down the
...
from RecommendNextComponentsMock import RecommendNextComponentsMock
from webgme_bindings import WebGME

logger = logging.getLogger("RecommendNextComponentsMock")
...
plugin = RecommendNextComponentsMock(
    webgme,
    COMMIT_HASH,
    BRANCH_NAME,
    ACTIVE_NODE_PATH,
